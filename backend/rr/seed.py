...
def create_users():
    ...
    sam = q.create_user(
        name='Sam Kozloff',
        pic_url=
        'https://fb-s-d-a.akamaihd.net/h-ak-xpa1/v/t1.0-1/c0.10.320.320/p320x320/1011706_10200499449670216_1138743800_n.jpg?oh=acba582368cd0eeb2ed87ff4413c14dc&oe=58B837F1&__gda__=1492541236_b53d275fac5d192b1dcafbf8e882fe1e',
        fb_access_token='sam',
        fb_id='sam', )
    ben = q.create_user(
        name='Ben Gulla',
        pic_url=
        'https://fb-s-c-a.akamaihd.net/h-ak-xta1/v/t1.0-1/c21.21.268.268/190380_1696803461385_1406884_n.jpg?oh=dc4908e59d9772a37f18a4d908a8b9db&oe=58FB1F53&__gda__=1489040026_d1fe333fd5351d9a7240d9b27c09bb65',
        fb_access_token='ben',
        fb_id='ben', )
    thuy = q.create_user(
        name='Nhi Thuy',
        pic_url=
        'https://fb-s-a-a.akamaihd.net/h-ak-xat1/v/t1.0-1/p320x320/15109589_1233522253380691_4726623713771430335_n.jpg?oh=fa043709409033acce0efbb59be4ab97&oe=58C07CDF&__gda__=1487981939_0b5d379f4462df48a0da94f44c78a510',
        fb_access_token='thuy',
        fb_id='thuy', )
    jimmy = q.create_user(
        name='Kyle James Meltzer',
        pic_url=
        'https://fb-s-c-a.akamaihd.net/h-ak-xtf1/v/t1.0-1/p320x320/14034954_10153838092398683_9193616731150996134_n.jpg?oh=939c5d482d3a4b59e8f2cd69cbad5b54&oe=58B376BB&__gda__=1488316830_00a785fff55e3fa5f176e1491a42bdfd',
        fb_access_token='jimmy',
        fb_id='jimmy', )
    justin = q.create_user(
        name='Justin Moen',
        pic_url=
        'https://fb-s-a-a.akamaihd.net/h-ak-xtf1/v/t1.0-1/p320x320/14915696_10207411476473760_4184340587655415773_n.jpg?oh=81cbc250213c861b71dd0d85b67cc804&oe=58B76472&__gda__=1488169047_9509afbd8197720c3c95d996910c4d65',
...
def create_compositions():
    ...
    _, today_prompt, yesterday_prompt = db.session.query(m.Prompt).order_by(
        m.Prompt.date.desc()).all()
    ...
    for i in range(len(psalms)):
        ...
        q.create_composition(
            ...
            prompt_id=today_prompt.id
            if created_at.date() == now.date() else yesterday_prompt.id,
            body=psalms[i], )
