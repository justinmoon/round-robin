...
class ProductionSecrets:
    ...
    DB_USER = 'root'
    DB_PASS = 'password'
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:password@/prod?unix_socket=/cloudsql/round-robin-prod:us-central1:app-engine'
...
class DevelopmentSecrets:
    SECRET_KEY = '5(15ds+i2+%ik6z&!yer+ga9m=e%jcqiz_5wszg)r-z!2--b2d'
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://user:password@localhost/round_robin_dev'
...
class TestSecrets:
    SECRET_KEY = '5(15ds+i2+%ik6z&!yer+ga9m=e%jcqiz_5wszg)r-z!2--b2d'
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://user:password@localhost/round_robin_test'
