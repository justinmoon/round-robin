...
class ProdSecrets:
    ...
    # REDIS_URL is for rq-dashboard, RQ_REDIS_URL is for flask-rq2
    REDIS_URL = RQ_REDIS_URL = 'redis://:jCAcVmpKW3nbehN@redis-18510.c9.us-east-1-2.ec2.cloud.redislabs.com:18510'
